	...
	function addUseOption(){
       	let html =""
            ...
            <div class="UseOptions">
                옵션명<input type="text" id="useOptions[${optionCount}].option_name" name="useOptions[${optionCount}].option_name">
                내용<textarea id="useOptions[${optionCount}].option_value" name="useOptions[${optionCount}].option_value"></textarea>
                <button type="button" onclick="removeOption(this)">옵션 제거</button>
            </div>
        `;
        $("#plusOptions").append(html);
